...
```{r}
plot(x,y)
abline(coef = c(-1,0.5),col = "yellow")
abline(fit,col="red")
legend("topleft",c("ls","regression"),col=c("red","yellow"),lty = c(1,2))
```
...
abline(linear_fit, col = "orange", lwd = 3)
legend("topleft", legend = c("Regression"), col = "orange", lty = 1, lwd = 3)
